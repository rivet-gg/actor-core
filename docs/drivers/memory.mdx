...
<Steps>
  <Step>
    ...
    <Tabs>
      <Tab title="npm">
        ```bash
        npm install rivetkit/memory rivetkit/nodejs
        ```
      </Tab>
      <Tab title="yarn">
        ```bash
        yarn add rivetkit/memory rivetkit/nodejs
        ```
      </Tab>
      <Tab title="pnpm">
        ```bash
        pnpm add rivetkit/memory rivetkit/nodejs
        ```
      </Tab>
      <Tab title="bun">
        ```bash
        bun add rivetkit/memory rivetkit/nodejs
        ```
      </Tab>
    </Tabs>
  </Step>
